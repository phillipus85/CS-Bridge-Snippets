...
RESUMEN DEL TUTORIAL:
    ...
    Incluye:
        - PARTE 1: Recordar como crear un lienzo (Funcion Lienzo()).
        - PARTE 2: Planear el dibujo de karel (descomposicion, dibujar por partes, conectar/retomar funciones).
        - PARTE 3: Escribir funcion para dibujar formas basicas de karel (rectangulos y cuadrados) en el lienzo (y crear_rectangulo()).
        - PARTE 4: Aplicar geometria (Centrar primer elementos en el lienzo y posicionar otros con respecto a el).
