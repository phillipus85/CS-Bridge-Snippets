...
LADO_CUADRADO = (2 * (DIAMETRO_CIRCULO // 2)**2)**(1 / 2)
ALTO_TRIANGULO = ((3)**(1 / 2) // 2) * (DIAMETRO_CIRCULO // 2)
LADO_TRIANGULO = (1 / 2) * (DIAMETRO_CIRCULO // 2)
...
def main():
    ...
    circulo = hoja.crear_rectangulo(pos_x_cuadrado,
                                    pos_y_cuadrado,
    ...
    pos_x_punto_b_triangulo = (ANCHO_LIENZO - DIAMETRO_CIRCULO / 2) // 2 - LADO_TRIANGULO
    pos_y_punto_b_triangulo = (ALTO_LIENZO + DIAMETRO_CIRCULO) // 2 - ALTO_TRIANGULO
    pos_x_punto_c_triangulo = (ANCHO_LIENZO + DIAMETRO_CIRCULO) // 2 + LADO_TRIANGULO
